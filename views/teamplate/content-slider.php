            ...
            <div class="widget-wrap">
                ...
                <div class="rslides_container">
                    <ul class="rslides rslides1" style="max-width: 1000px;">
                        <li id="rslides1_s0" class="" style="display: block; float: none; position: absolute; opacity: 0; z-index: 1; transition: opacity 500ms ease-in-out;"><img src="<?php echo url(); ?>public/fontend/images/banner/banner1.jpg" alt="slider"></li>
                        <li id="rslides1_s1" style="float: left; position: relative; opacity: 1; z-index: 2; display: list-item; transition: opacity 500ms ease-in-out;" class="rslides1_on"><img src="<?php echo url(); ?>public/fontend/images/banner/banner2.jpg" alt="slider"></li>


                        <li id="rslides1_s1" style="float: left; position: relative; opacity: 1; z-index: 2; display: list-item; transition: opacity 500ms ease-in-out;" class="rslides1_on"><img src="<?php echo url(); ?>public/fontend/images/banner/banner3.jpg" alt="slider"></li>
        ...
        <div id="text-14" class="widget widget_text">
            <div class="widget-wrap">
                <div class="textwidget">
                    <img src="<?php echo url(); ?>upload/baohanh.jpg">
                </div>
            </div>
        </div>
    </div>
