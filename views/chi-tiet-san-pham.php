                        ...
                        <div class="infor">
                                ...
                                <div class="connected-carousels">
                                    <div class="stage">
                                        <div class="carousel carousel-stage" data-jcarousel="true">
                                            <ul>
                                                <li>
                                                    <a href="../../upload/product/<?php echo $value['avatar'] ?> " data-rel="lightbox-0" title="">
                                                        <p class="item" style="background:url(<?php echo url().'upload/product/'.$value['avatar']; ?>) no-repeat center center;"></p>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="right-info">
                                ...
                                <div id="post-ratings-193659-loading" class="post-ratings-loading">
                                    <img src="../public/fontend/images/loading.gif" width="16" height="16" class="post-ratings-image" />Loading...
                                </div>
                                <div class="addthis_native_toolbox">
                                    
                                </div>
                                <div class="chitietsp">
                                    <p class="tinhtrang">Số lượng: <span><?php echo $value['quantity'] ?></span></p><br/>
                                </div>

                                <!-- <div class="chitietsp">
                                    <p class="tinhtrang">Nhà cung cấp: <span><?php //echo $value['supplier'] ?></span></p><br/>
                                </div> -->
                                <!-- <div class="chitietsp">
                                    <p class="tinhtrang">Khối lượng: <span><?php //echo $value['kg'] ?></span></p><br/>
                                </div> -->
                                ...
                                <div id="buy-product1" class="buy-product1">
                                    <a class="addtocart" title="Đặt mua" href="../Controller/them-gio-hang.php?action=addtocart&id=<?php echo $value['id'] ?>" rel="193659">Cho vào giỏ hàng</a>
                                    <a class="mngay" title="Mua ngay" href="gio-hang.php" >Xem giỏ hàng</a>
                                </div>
                            </div>
                                ...
                                <li class="sp">
                                    <div class="image-sp">
                                        <a href="chi-tiet-san-pham.php?id=<?php echo $value['id'] ?>">
                                            <div class="imghome" style="background:url(<?php echo url().'upload/product/'.$value['avatar']; ?>) no-repeat center center;"/></div>
                                        </a>
                                    </div>
                                    <h3><a href="chi-tiet-san-pham.php?id=<?php echo $value['id'] ?>" rel="bookmark" title="<?php echo $value['name'] ?> "><?php echo $value['name'] ?></a></h3>
                                    <div class="show-gia">
                                        <?php if($value['sale'] == 0): ?>
                                    ...
                                    <div id="buy-product" class="buy-product">
                                        <a class="addtocart" title="Đặt mua" href="../Controller/them-gio-hang.php?action=addtocart&id=<?php echo $value['id'] ?>" rel="103356">Cho vào giỏ hàng</a>
                                    </div>
                                </li>
                            <?php endforeach; ?>
                            </ul>
